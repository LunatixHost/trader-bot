...
FUTURES_TRAIL_ACTIVATION_PCT        = 0.40    # Trailing stop activates after this unrealised gain % — raised 0.30→0.40 to let winners breathe
FUTURES_TRAIL_DISTANCE_PCT          = 0.20    # Trail distance once activated
FUTURES_STAGNATION_MINUTES_T1       = 8       # Early exit if no movement by T1
FUTURES_STAGNATION_THRESHOLD_T1     = 0.05    # Minimum % gain by T1 to avoid stagnation exit
FUTURES_STAGNATION_MINUTES_T2       = 15      # Hard stagnation exit time
